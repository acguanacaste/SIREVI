...
-- -----------------------------------------------------
-- procedure Consulta_Reporte_Paises
-- -----------------------------------------------------

USE `sirevi`;
DROP procedure IF EXISTS `sirevi`.`Consulta_Reporte_Paises`;

DELIMITER $$
USE `sirevi`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `Consulta_Reporte_Paises`( )
BEGIN

(SELECT provincia.nombre AS Pais_Provincia, sector.nombre AS Sector, subSector AS SubSector, count(visitacion.subSector) AS Registros_SubSector,
SUM(visitacion.nacional_adult+visitacion.nacional_kid+visitacion.estudiantes) AS Pagos,
SUM(visitacion.nacional_prepago) AS Prepagos,
...
SUM(visitacion.nacional_adult+visitacion.nacional_kid+visitacion.estudiantes) AS Pagos,
SUM(visitacion.extranjero_prepago) AS Prepagos,
SUM(visitacion.nacional_exonerado) AS Exonerados,
SUM(visitacion.nacional_adult+visitacion.nacional_kid+visitacion.estudiantes
	+visitacion.nacional_exonerado+visitacion.nacional_prepago) AS Total
FROM visitacion
...
SUM(visitacion.nacional_adult+visitacion.nacional_kid+visitacion.estudiantes) AS Pagos,
SUM(visitacion.nacional_prepago+visitacion.extranjero_prepago) AS Prepagos,
SUM(visitacion.nacional_exonerado+extranjero_exonerado) AS Exonerados,
SUM(visitacion.nacional_adult+visitacion.nacional_kid+visitacion.estudiantes
	+visitacion.nacional_exonerado+visitacion.nacional_prepago) AS Total
FROM visitacion
INNER JOIN pais ON visitacion.pais_id = pais.id
...
-- -----------------------------------------------------
-- procedure Totales_ACG
-- -----------------------------------------------------

USE `sirevi`;
DROP procedure IF EXISTS `sirevi`.`Totales_ACG`;

DELIMITER $$
USE `sirevi`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `Totales_ACG`()
BEGIN
