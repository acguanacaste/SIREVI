...
#WHERE fecha BETWEEN '2018-05-18 00:00:00' AND '2018-05-18 23:59:59'

call prueba('2018-05-18 00:00:00', '2018-05-18 23:59:59', 2);

SELECT count(salida) AS cANT FROM visitacion
WHERE salida = 0;
END$$
...
BEGIN
SELECT count(visitacion.id) AS Cantidad FROM visitacion;
END$$
...
BEGIN
SELECT count(salida) AS Cantidad FROM visitacion
WHERE salida = 0;
END$$
