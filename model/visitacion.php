...
class Visitacion extends Database
{
...
//-----------------------------------------------------------------
    ...
    public function ControlSalidas()
    {/*Metodo que me borra los datos en la bd*/
        try {
    ...
    /*==============================================================================================*/
    public function Consulta_Totales_por_Sector_Model($fechaStart, $fechaEnd, $pSector)
    {//Funcion up and working
        $result = array();
        try {
    ...
    public function Consulta_Campistas_Model($fechaStart, $fechaEnd, $pSector)
    {//Funcion up and working
        $result = array();
        try {
