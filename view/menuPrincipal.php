 ...
 <a class=' dropdown-button btn' href='#' style="color:white;" data-activates='dropdown1' > Menu Registros</a>
       <!-- Dropdown Structure -->
           <ul id='dropdown1' class='dropdown-content' >
             ...
             <li class="divider"></li>
             <li><a href="index.php?c=Pais"      > Modulo Pais</a></li><!--Recordar la ortografia-->
      ...
      <div class="container contact">
       ...
       <h6></h6>
             <div class=""><!--INICIO DE LA PREVISTA DE DIV'S-->
               <div class="col s4 m5 l4"><!--DIV QUE ME DECLARA EL TAMANO DE ANCHO DEL CUERPO DE LA PREVISTA DE LAS DIVICIONES-->
                <hr>
                 <div >
...
<!--===========================================================================================================================================-->
                <textarea class="materialize-textarea" placeholder="Your Message" required>
                </textarea>
