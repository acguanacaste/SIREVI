          ...
          <div class="row">
            <form id="frm-provincia" action="?c=Provincia&a=Guardar" method="post" enctype="multipart/form-data">
              ...
              <div>
                ...
                <div class="row"><!---INICIO DE LA PRIMERA FILA-->
                  ...
                  <div class="input-field col s6 m5 l6  ">
                   <input  id="last_name" type="text" name="nombre" value="" class="validate" class="form-control" data-validacion-tipo="requerido|min:10" >
                   <label for="last_name" >  <i class="small material-icons">label</i>Nombre de Provincia</label>
                   </div>
              ...
              <div class="input-field col s6 m5 l6  ">
               ...
               <label for="last_name" >  <i class="small material-icons">code</i>Codigo de Provincia</label>
               </div>
