  ...
  <nav class="top-nav">
    <div class="container">
      <div class="nav-wrapper"><a class="page-title"></a>
        <a href="#!" class="brand-logo">Provincias</a>
              ...
              <tbody>
                <?php foreach($this->model->Listar() as $r): ?>
                  <tr>
                    ...
                    <td>
                      <a href="?c=Provincia&a=Modificar&id=<?php echo $r->id; ?>"><i class="small material-icons right">edit</i></a>
                    </td>
                    <td>
                      <a onclick="javascript:return confirm('¿Seguro de eliminar este registro ?');" href="?c=Provincia&a=Eliminar&id=<?php echo $r->id; ?>">
