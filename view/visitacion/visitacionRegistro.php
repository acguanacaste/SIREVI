...
<!--==================================================================================================================================-->
    <!--==================================================Lineas de codigo, respecto visitacion=========================================================-->
              ...
              <fieldset class="input-field col s12 m6 l8">
                <legend>Referencia Visitacion</legend>
                <table >
                <tr>
                  <td colspan="3">
                ...
                <tr>
                  <td>Nombre: </td>
                    <td><input placeholder="Nombre de Referencia" type="text" name="nombre_referenciaVisita" value="" disabled>
                  </td>
                </tr>
              </table>
              </fieldset>
