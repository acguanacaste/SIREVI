...
<body class="body">
  <main>
    <div class="container">
      <h4 class="header left"><span class="hide-on-med-and-down">Modulo Reportes</span></h4>
      ...
      <div class="row">
        ...
        <table class="responsive-table grey lighten-1 centered highlight z-depth-5">
              ...
              <li class="collection-item avatar">
                ...
                <a><p><a href="?c=Visitacion&a=Reporte">Reporte Nacionalidades</a><br>
                    <span class="hide-on-small-only">
                      A través de este enlace se realiza la creación de un informe <br>
                      de las nacionalidades</span>
                    </p></a>
