    ...
    <div class="container">
      <div class="nav-wrapper"><a class="page-title"></a>
        <a href="#!" class="brand-logo">&nbsp;SIREVI</a>
          ...
          <li><a href="Index.php"><i title="inicio" class="material-icons right">home</i>Inicio</a></li>
              ...
              <tbody>
                <?php foreach($this->model->Listar() as $r): ?>
                  <tr>
                    ...
                    <td>
                      <a href="?c=Usuario&a=Crud&id=<?php echo $r->id; ?>"><i class="small material-icons right">edit</i></a>
                    </td>
                    <td>
                      <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?c=Usuario&a=Eliminar&id=<?php echo $r->id; ?>">
