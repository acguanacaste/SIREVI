    ...
    <div class="container">
      <div class="nav-wrapper"><a class="page-title"></a>
        <a href="#!" class="brand-logo">&nbsp;SIREVI</a>
          ...
          <li><a  href="index.php?c=Usuario" ><i title="regresar" class="material-icons">refresh</i></a></li>
  ...
  <!--============================= Inicio de los modulos del sistemas ====================================================-->
        <li class="no-padding">
          <ul class="collapsible collapsible-accordion">
            <li><a href="index.php?c=Usuario&a=agregarRegistro">  <i class="small material-icons">playlist_add</i>Realizar Registro</a></li>
    ...
    <div class="container contact">
     ...
     <!--INICION DE COLUMNA DEL CEDULA-->
                   <div class="row"><!--INICIO DEL DIV DE LA SEGUNDA FILA-->
                     <div class="input-field col s6 m5 l6 ">
                       <input  id="disabled" type="text" name="cedula" disabled value="" value="" class="form-control"  class="validate" data-validacion-tipo="requerido|min:15">
                       <label for="cedula"> <i class="small material-icons">picture_in_picture</i>Cédula</label>
                     </div>

                   <!--INICIO DE COLUMNA CONTRASENA-->
                   <div class="input-field col s6 m5 l6  ">
                   <input  id="contrasena" type="text" name="contrasena" disabled value=""  value="<?php echo $user->contrasena; ?>" class="validate" class="form-control" data-validacion-tipo="requerido|min:10">
             ...
             <div class="row"><!--INICIO DE TERCERA FILA-->
                 <div class="row">
                   <div class="input-field col s12">
                     <input id="puesto" type="text" name="puesto" value="<?php echo $user->puesto; ?>" class="form-control" class="validate" data-validacion-tipo="requerido|min:20">
                     <label for="puesto"><i class="small material-icons">description</i>&nbsp;Puesto en institución </label>
                   </div>
                 </div>
        ...
        <li class="bold"><a class="collapsible-header  waves-effect waves-teal">
          ...
          <div class="collapsible-body" style="display: block;">
            <ul>
              ...
              <li><a href="index.php?c=Alumno"> Modulo Alumno</a></li>
              <li><a href="index.php?c=Usuario"> Modulo Usuarios</a></li>
