<div class=""  >
  ...
  <!--          <form id="paypal-donate" action="https://www.paginaWeb.com/cgi-bin/webscr" method="post" target="_top">
          ...
          <div class="col l4 s12">
            <h5 class="white-text">Área de Conservacion Guanacaste(A.C.G)</h5>
