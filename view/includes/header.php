...
<!--=========================================================================-->
					...
					<ul id="nav-mobile" class="left hide-on-small-only">
						...
						<li><a href="" data-activates="slide-out-2" title="Buscar Registro"  class="derecha"><i title="Buscar Registro" style="color:white" class=" small material-icons">search</i></a></li>
