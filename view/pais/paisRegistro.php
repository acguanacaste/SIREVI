    ...
    <div class="container contact">
      ...
      <div class="row">
        <div class="col s14 m14 l11">
          <div class="row">
            <form id="frm-pais" action="?c=Pais&a=Guardar" method="post" enctype="multipart/form-data">
              <input type="hidden" name="id" value="" />

              <div>
								<label> Seleccion de paices</label>
                <div class="row"><!---INICIO DE LA PRIMERA FILA-->
	                    ...
	                    <option value="" disabled selected>Elija el pais</option>
				 							...
				 							<option value="Chila">Chile</option>
											<option value="China">China</option>
				 							<option value="Colombia">Colombia</option>
				 							<option value="Korea">Corea</option>
				 							<option value="Costa Rica" selected>Costa Rica</option><!--PARA QUE SEA EL DEFAULT DEL SELECT Y LA OPCION ESTE AHI-->
              ...
              <div class="input-field col s6 m5 l6  ">
               <input  id="last_name" type="text" name="codigo" value="" class="validate" class="form-control" data-validacion-tipo="requerido|min:10" >
               <label for="last_name" >  <i class="small material-icons">code</i>Codigo del Pais</label>
               </div>
