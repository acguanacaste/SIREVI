  ...
  <nav class="top-nav">
    <div class="container">
      <div class="nav-wrapper"><a class="page-title"></a>
        <a href="#!" class="brand-logo">Paices</a>
              ...
              <tbody>
                <?php foreach($this->model->Listar() as $r): ?>
                  <tr>
                    ...
                    <td>
                      <a href="?c=Pais&a=Modificar&id=<?php echo $r->id; ?>"><i class="small material-icons right">edit</i></a>
                    </td>
                    <td>
                      <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?c=Pais&a=Eliminar&id=<?php echo $r->id; ?>">
...
<div class="buysellads hide-on-small-only">
  ...
  <script async="" type="text/javascript"
  src="//cdn.carbonads.com/carbon.js?zoneid=1673&amp;serve=C6AILKT&amp;placement=materializecss" id="_carbonads_js"></script>
  <div id="carbonads">
    <span>
      <span class="carbon-wrap">
        <a href="" class="carbon-img" target="_blank">
          <img src="//assets.servedby-buysellads.com/p/manage/asset/id/28342" alt="" style="max-width: 130px;" height="100" border="0" width="130"></a>
          <a href="//srv.carbonads.net/ads/click/x/GTND423YCV7I5KJJF6A4YKQWFT7DVK3YCEBI4Z3JCEAD6K7MCKYDP27KC6BDEKJICA7DTK3EHJNCLSIZ?segment=placement:materializecss;" class="carbon-text" target="_blank">Forget about SMTP. Send email using Mailgun's API. Get started today.</a></span>
          <a href="http://carbonads.net/" class="carbon-poweredby" target="_blank">ads via Carbon</a></span></div>
      </div>-->
